...
from model.unet2 import UNetPlusPlusTwoView # modified
...
def main():
    ...
    parser.add_argument("--model", type=str, default="Echocare", choices=["Echocare", "UNet", "UNet++"], #modified
                        help="Model architecture to use: 'Echocare' or 'UNet' or 'UNet++'")
    ...
    if args.model == "Echocare":
        ...
        model = UNetTwoView(in_chns=1, seg_class_num=3, cls_class_num=1)
    elif args.model == "UNet++":
        model = UNetPlusPlusTwoView(in_chns=1, seg_class_num=3, cls_class_num=1)
